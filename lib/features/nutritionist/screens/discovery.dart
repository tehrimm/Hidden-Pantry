        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SkeletonBox(width: 150.sw, height: 18.sh, glassy: true),
                const SizedBox(height: 8),
                SkeletonBox(width: 80.sw, height: 12.sh, glassy: true),
                const SizedBox(height: 12),
                SkeletonBox(width: double.infinity, height: 12.sh, glassy: true),
                const SizedBox(height: 6),
                SkeletonBox(width: 180.sw, height: 12.sh, glassy: true),
              ],
            ),
          ),
        ],
